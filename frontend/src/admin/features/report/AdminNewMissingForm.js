...
const AdminNewMissingForm = ({ users }) => {
    ...
    const canSaveMissingReport = [itemName, itemDescription, dateMissing, selectedLocation !== 'Choose Location', image, reportType].every(Boolean)
        ...
        <div className='p-8 lg:p-20 w-full rounded-lg border'>
            <div className='md:pb-4 flex flex-col md:flex-row md:justify-between gap-4 md:gap-0'>
                ...
                <div className="flex pb-2">
                    ...
                    >
                        <Link to={`/admin/dash/reports/missing`}>
                            See Reports Table
                        </Link>
