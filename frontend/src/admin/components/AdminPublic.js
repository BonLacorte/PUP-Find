...
const Public = () => {
    const content = (
        ...
        <div className="bg-white flex flex-col items-start">
            {/* Header */}
            <div className="w-full bg-primaryColor top-0 left-0 flex-row justify-between items-center hidden lg:flex lg:px-32 xl:px-56" id="NAVBAR">
                <img alt=""
            ...
            <div className="bg-white flex flex-row items-end justify-center w-screen h-screen lg:h-[90vh] ">
                ...
                <div className="flex flex-col lg:w-[50%] h-full items-start 2xl:items-center justify-center px-4 lg:px-8">
                    ...
                    <div className='lg:px-2'>
                        ...
                        <div className="flex flex-col w-full lg:flex-row gap-5 items-center justify-center">
                                ...
                                <button className="bg-primaryColor flex flex-col justify-center items-center rounded-md w-full py-2 px-4">
                                    <Link to={`/admin/login`} className="text-center text-lg font-semibold text-white">
                                    LOGIN AS ADMIN
