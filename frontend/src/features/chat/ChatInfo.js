...
import { Image, Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon, Box
...
const ChatInfo = () => {
    ...
    return (
        <div className={`${selectedChat ? 'hidden' : 'flex'} lg:${selectedChat ? 'flex' : 'flex'} flex-col p-3 bg-white h-[90vh] lg:w-1/3 rounded-lg border border-gray-300`}>
            {selectedChat ? (
                <>
                        ...
                        {chatMate ? (
                            <div className="p-3 border-b border-gray-300">
                                ...
                                <div>
                                    ...
                                    {foundReports ? 
                                        <div className="overflow-y-auto max-h-[180px] border-blue-500">
                                            <ScrollableFeed>
                                                <Accordion defaultIndex={[0]} allowMultiple>
