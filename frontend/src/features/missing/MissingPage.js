...
const MissingPage = () => {
    return (
        <div className="bg-white flex flex-col justify-center items-center w-full h-[90vh] border-blue-700 ">
            ...
            <div className="flex flex-row justify-center items-center lg:w-3/5 w-full px-10 border-red-700">
                {/* Buttons and Info */}
                    ...
                    <div className="gap-10 flex flex-col items-start border-orange-600">
                        ...
                        <div className="flex flex-col justify-between gap-4 w-full items-start">
                            <span className="text-2xl md:text-4xl font-semibold w-5/6">
                                ...
                                <button className="bg-primaryColor flex flex-col justify-center items-center rounded-md py-2 px-4">
                                    <Link to={`/dash/missing/new`} className="text-center text-sm md:text-lg font-semibold text-white">
                                            CONNECT
                                    </Link>
                                </button>
                ...
                {/* Design */}
                <div className="hidden xl:flex self-end flex-row mb-4 gap-6 items-start border-green-700">
